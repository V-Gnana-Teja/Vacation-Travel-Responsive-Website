  ...
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
        ...
        <div className='flex flex-col h-full justify-center'> 
            ...
            <p className='text-2xl py-6'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aspernatur, iusto!</p>
            <p className='pb-6'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sint illo eveniet laudantium. Rerum cumque perferendis iusto aspernatur cum debitis? Veniam vero ullam perferendis saepe consequuntur doloremque iure ipsum ad ex!</p>
